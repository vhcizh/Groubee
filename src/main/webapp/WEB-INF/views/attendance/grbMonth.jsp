	...
	<div id="main-wrapper" style="height:100%;">
		...
		<div class="page-wrapper">
			...
			<div class="email-app position-relative" style="height: 100%;">
				...
				<!-- Right Part -->
				<!-- ============================================================== -->
				<form name="grbmonthform" method="post">
		...
		$(function () {    
			new Chart(document.getElementById("pie-chart"), {
				...
				data: {
				  ...
				  datasets: [{
					label: "attendance",
					backgroundColor: ["#02cccd", "#ff3ca6","#6610f2","#ffab2e", "005ccce", "#ffab2e", "005ccce"],
					data: ['${attendin_cnt}'
						,'${attendout_cnt}'
						,'${over_cnt}'
						,'${late_cnt}'
	...
	<script type="text/javascript">				
        ...
        $(function() {
    		...
    		$(".selectdepart").change(function(){   			
   	         	...
   	         	location.href = "${path}/grbMonth.at?depart_name=" + depart_name;            
           }); 
    		...
    		$(".selectmonth").change(function(){
    	         ...
    	         location.href = "${path}/grbMonth.at?month=" + monthVal;            
            });    		                 
