                            ...
                            <ul class="nav nav-pills custom-pills" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="pills-setting-tab" data-toggle="pill" href="#previous-month"
                                        role="tab" aria-controls="pills-setting" aria-selected="false">팀 설계</a>
                                </li>
                                 <li class="nav-item">
                                    <a class="nav-link" id="pills-setting-tab" data-toggle="pill" href="#human_team"
                                        role="tab" aria-controls="pills-setting" aria-selected="false">팀 배정</a>
                                </li>
                            </ul>
                            <!-- Tabs -->
			<div class="tab-content" id="pills-tabContent">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <hr class="mt-0">
                            <form class="form-horizontal r-separator" name="depart_name" action="${path}/departInsert.ad" method="post">
                                        ...
                                        <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                ...
                                                <div class="depart_name">
                                                    <input type="text" name="depart_name" class="form-control" id="depart_name" size="50" required
                                                        placeholder="부서명">
                                                </div>
                                            </div>
                                        </div>
                                          <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                <label for="inputEmail3"
                                                    class="col-sm-3 text-right control-label col-form-label">회사번호</label>
                                                <div class="company_id">
                                                    <input type="text" name="company_id" class="form-control"  id=company_id  size="10"
                                                         >
                                                </div>
                                            </div>
                                        </div>
                                          <div class="col-sm-12 col-lg-6">
                                            <div class="form-group row">
                                                <label for="inputEmail3"
                                                    class="col-sm-3 text-right control-label col-form-label">노출여부</label>
                                                <div class="show">
                                                	  <select class="form-control custom-select"  id="show" name="show" required>
														<option id = "0" value="">공개여부</option>
														<option id = "1" value="1">공개</option>
														<option id = "2" value="0">비공개</option>
													  </select>	
                                                </div>
                                            </div>
                                        </div>
                ...
                <!-- 직무/담당  -->
                         ...
                         <div class="tab-pane fade" id="previous-month" role="tabpanel"
                             ...
                             <div class="card-body">
                                 <form class="form-horizontal form-material" action="${path}/teamInsert.ad" method="post" name="teamInsert">
                                   <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
                                     <div class="form-group">
                                         <label class="col-md-12">부서</label>
                                         <div class="col-md-12">
                                           <select class="form-control custom-select" id="depart_name" name="depart_name" required>
											<option value="">부서 선택</option>
											<c:forEach var="dto" items="${list}">
											<option value="${dto.depart_name}">${dto.depart_name}</option>
											</c:forEach>												
										  </select>		
                                         </div>
                                     </div>
                                     <div class="form-group">
                                         <label class="team_name">팀</label>
                                         <div class="col-md-12">
                                             <input type="text" id="team_name" name="team_name" maxlength="20"  placeholder="팀명" required>
                                         </div>
                                     </div>
                                     <div class="form-group">
                                         <label class="col-md-12">생성날짜</label>
                                         <div class="col-md-12">
                                             <input type="Date" id="ap_day" name="ap_day" 
                                                 class="form-control form-control-line">
                                         </div>
                                     </div>
                                     <div class="form-group">
                                         <label class="col-md-12">팀 상세소개</label>
                                         <div class="col-md-12">
                           ...
                           <div class="tab-pane fade" id="human_team" role="tabpanel"
                             aria-labelledby="pills-setting-tab">
                             <div class="card-body">
                                 <form class="form-horizontal form-material" action="${path}/human_team.ad" method="post" name="teamInsert">
                                   <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
                                     <div class="form-group">
                                         <label class="col-md-12">부서</label>
                                         <div class="col-md-12">
                                     ...
                                     <div class="form-group">
                                         ...
                                         <select class="form-control custom-select" id="team_name" name="team_name" required>
											...
											<c:forEach var="dto2" items="${teamlist}">
											<option value="${dto2.team_name}">${dto2.depart_name} ${dto2.team_name}</option>
											</c:forEach>										
										  </select>		
                                     </div>
                                     <div class="form-group">
                                         <label class="col-md-12">발령일</label>
                                         <div class="col-md-12">
                                             <input type="Date" id="ap_day" name="ap_day" 
                                                 class="form-control form-control-line">
                                         </div>
                                      ...
                                      <div class="form-group">
                                         <label class="team_name">사번</label>
                                         <div class="col-md-12">
                                             <input type="text" id="id" name="id" maxlength="20"  placeholder="사번을입력하세요" required>
                                         </div>
                                     </div>
                                     <div class="form-group">
                                         <label class="col-md-12">담당 업무</label>
                                         <div class="col-md-12">
                                             <textarea rows="5" id="contents" name="contents" 
                                                 class="form-control form-control-line">
                                                 </textarea>
