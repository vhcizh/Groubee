...
<script type="text/javascript">
	...
	opener.document.location.reload();
     ...
     <div>
         ...
         <div class="card-body border-bottom">
	     	<h5 class="mb-0 font-16 font-weight-medium">보낸 사람 ${dto.id} ${dto.depart_name} ${dto.name}</h5>
	     	<!--  -->
	     	<h5 class="mb-0 font-16 font-weight-medium">받는 사람 ${dto.getter_id} ${dto.depart_name} ${dto.name}</h5>
