            ...
            <div class="container-fluid">
                ...
                <div class="row button-group">
				    <div class="col-lg-2 col-md-4">
				        <button type="button" class="btn btn-rounded btn-block btn-outline-info" onclick = "location.href='${path}/adMessage.ad'">사원 통합 메세지 관리함</button>
				    </div>
				    <div class="col-lg-2 col-md-4">
				        <button type="button" class="btn btn-rounded btn-block btn-outline-info" onclick = "location.href='${path}/adMsgSend.ad'">관리자 메세지 발신</button>
				    </div>
				</div>
				<hr><br>
					<div class="card">
                    	<div class="card-body">
                        	<h4 class="card-title">관리자 메세지 발신</h4>
                            <br>
