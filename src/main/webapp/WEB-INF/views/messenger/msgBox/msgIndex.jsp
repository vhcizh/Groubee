...
<script type="text/javascript">
	$(function() {
		...
		$('#readBtn').click(function() {
			document.msgListForm.action ="${path}/readState.me";
			document.msgListForm.submit();
		});
		
		// unreadBtn
		$('#unreadBtn').click(function() {
			document.msgListForm.action ="${path}/unreadState.me";
			document.msgListForm.submit();
		});
		                    ...
		                    <div class="bg-light p-3 d-flex align-items-center do-block">
		                        ...
		                        <div class="ml-auto">
		                            <div class="btn-group mr-2" role="group" aria-label="Button group with nested dropdown">
		                                <button type="button" id="readBtn" class="btn btn-outline-secondary font-18" 
		                                onclick="location.href='${path}/readState.me'">읽음</button>
		                                <button type="button" id="unreadBtn" class="btn btn-outline-secondary font-18"
		                                onclick="location.href='${path}/unreadState.me'">안읽음</button>
