...
<link rel="stylesheet" type="text/css"
	href="${path}/assets/libs/ckeditor/samples/css/samples.css">
<!-- Custom CSS -->
				...
				.click(
						function() {
							if (confirm("임시보관을 하시겠습니까?")) {
								document.approvalForm.action = "${path}/tempSavetep.fo?${_csrf.parameterName}=${_csrf.token}";
				...
				.click(
						function() {
							if (confirm("문서를 기안 하시겠습니까?")) {
								document.approvalForm.action = "${path}/approvereqtep.fo?${_csrf.parameterName}=${_csrf.token}";
								document.approvalForm.submit();
							}
						});
	});
...
<body>
	<span style="font-family: &amp; amp; amp; quot; 맑은 고딕&amp;amp; amp; quot;; font-size: 10pt; line-height: normal; margin-top: 0px; margin-bottom: 0px;">
		<span style="font-family: &amp; amp; amp; quot; 맑은 고딕&amp;amp; amp; quot;; font-size: 10pt; line-height: normal; margin-top: 0px; margin-bottom: 0px;">
			<form name="approvalForm" method="post" enctype="multipart/form-data">
				...
				<table
					...
					<tr>
						...
						&nbsp;
						<c:forEach var="dto" items="${list}" begin="0" end="0">
						<button type="button" onClick="window.open('${path}/selectmemberLine.ap?doc_id=${dto.doc_id}','결재선','width=800,height=800,location=no,status=no,scrollbars=yes');">결재정보변경</button>
						</c:forEach>
					</tr>
					<hr>
					<!-- Header -->
					...
					<tbody>
						<tr>
							<td
								...
								colspan="2"><c:forEach var="dto" items="${list}" begin="0"
									end="0"> 
				${dto.form_name}
			</c:forEach></td>
						</tr>
						<tr>
							<td
								...
								<table
									style="border: 1px solid rgb(0, 0, 0); font-family: &amp; amp; amp; quot; malgun gothic&amp;amp; amp; quot; , dotum , arial, tahoma; margin-top: 1px; border-collapse: collapse; width: 318px;">
									<!-- User -->
									<colgroup>
										<col width="90">
										<col width="120">
										...
										<tr>
											...
											<td
												...
												data-value="" data-autotype=""> <span
													class="comp_item"
													style="font-family: &amp; amp; amp; quot; malgun gothic&amp;amp; amp; quot; , dotum , arial, tahoma; font-size: 9pt; line-height: normal; margin-top: 0px; margin-bottom: 0px;">-</span>
											...
											<td
												...
												data-value="" data-autotype=""> <span
													...
													style="display: none; font-family: &amp; amp; amp; quot; malgun gothic&amp;amp; amp; quot; , dotum , arial, tahoma; font-size: 9pt; line-height: normal; margin-top: 0px; margin-bottom: 0px;">
														...
														style="font-family: &amp; amp; amp; quot; malgun gothic&amp;amp; amp; quot; , dotum , arial, tahoma; font-size: 9pt; line-height: normal; margin-top: 0px; margin-bottom: 0px;"></span>
														<span class="Active_dot3"
														style="font-family: &amp; amp; amp; quot; malgun gothic&amp;amp; amp; quot; , dotum , arial, tahoma; font-size: 9pt; line-height: normal; margin-top: 0px; margin-bottom: 0px;"></span><span
														class="Active_dot4"
														style="font-family: &amp; amp; amp; quot; malgun gothic&amp;amp; amp; quot; , dotum , arial, tahoma; font-size: 9pt; line-height: normal; margin-top: 0px; margin-bottom: 0px;"></span>
												</span> <span contenteditable="false" class="comp_hover"
							...
							<td
								style="background: white; padding: 0px !important; border: currentColor; align: right; color: black; font-size: 12px; font-weight: normal; vertical-align: top;">
								<table style="float: right">
									<tr>
										<c:forEach var="dto" items="${list2}">
											<td
												style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; color: rgb(0, 0, 0); font-size: 10px; font-weight: normal; vertical-align: middle; text-align: center; width: 60px; height: 10px;">(${dto.co_approve})</td>
										</c:forEach>
									</tr>
									<tr>
										<c:forEach var="dto" items="${list2}">
											<td
												style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; color: rgb(0, 0, 0); font-size: 10px; font-weight: normal; vertical-align: middle; text-align: center; width: 60px; height: 10px;">${dto.rank}</td>
										</c:forEach>
									</tr>
									<tr>
										<c:forEach var="dto" items="${list2}">
											<td
												style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; color: rgb(0, 0, 0); font-size: 10px; font-weight: normal; vertical-align: top; text-align: center; width: 60px; height: 60px;">${dto.name}<br>
												<c:if test="${dto.load_status == '결재'}">
													<img src="${path}/resources/images/adminImages/stamp.png">
												</c:if></td>
										</c:forEach>
									</tr>
									<tr>
										<c:forEach var="dto" items="${list2}">
											<td
												style="background: rgb(255, 255, 255); padding: 5px; border: 1px solid black; color: rgb(0, 0, 0); font-size: 10px; font-weight: normal; vertical-align: middle; text-align: center; width: 60px; height: 10px;">${dto.checkday}</td>
										</c:forEach>
									</tr>
								</table> <span unselectable="on" contenteditable="false"
							...
							</span> <!-- 에디터 &nbsp; 버그. 개행과 공백을 최소화 시키자. --> <!-- 에디터 &nbsp; 버그. 개행과 공백을 최소화 시키자. -->
								<br>
				...
				<table
					style="border: 2px solid; width: 800px; font-family: &amp; amp; amp; quot; malgun gothic&amp;amp; amp; quot; , dotum , arial, tahoma; margin-top: 10px; border-collapse: collapse; height: 385px;">
					<colgroup>
						<col width="140">
						<col width="660">
					</colgroup>
		...
		제&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;목
							...
							<td
								...
								data-wrapper=""
								style="width: 100%; font-family: &amp; amp; amp; quot; malgun gothic&amp;amp; amp; quot; , dotum , arial, tahoma; font-size: 9pt; line-height: normal; margin-top: 0px; margin-bottom: 0px;"
								data-value="" data-autotype=""> <input class="ipt_editor"
									name="title" type="text" size="100" value="${dto.title}">
									<span contenteditable="false" class="comp_active"
									style="display: none; font-family: &amp; amp; amp; quot; malgun gothic&amp;amp; amp; quot; , dotum , arial, tahoma; font-size: 9pt; line-height: normal; margin-top: 0px; margin-bottom: 0px;">
										<span class="Active_dot1"
										style="font-family: &amp; amp; amp; quot; malgun gothic&amp;amp; amp; quot; , dotum , arial, tahoma; font-size: 9pt; line-height: normal; margin-top: 0px; margin-bottom: 0px;"></span>
						...
						<tr>
							<td
								...
								data-value="" data-autotype=""><span class="comp_editor"
									style="width: 100%; font-family: &amp; amp; amp; quot; malgun gothic&amp;amp; amp; quot; , dotum , arial, tahoma; font-size: 11pt; line-height: 200px; margin-top: 0px; margin-bottom: 0px;">
										<textarea cols="80" id="testedit1" name="content" rows="10"
											data-sample="2" data-sample-short>
                                			${dto.content} 
                </textarea>
									...
									style="font-family: &amp; amp; amp; quot; malgun gothic&amp;amp; amp; quot; , dotum , arial, tahoma; font-size: 9pt; line-height: normal; margin-top: 0px; margin-bottom: 0px;">
										...
										data-content-protect-cover="true"
										data-component-delete-button="true"></a>
								</span> </span><br> <a class="btn" href="${dto.files}" download><p
										style="font-family: &amp; amp; amp; quot; 맑은 고딕&amp;amp; amp; quot;; font-size: 10pt; line-height: 20px; margin-top: 0px; margin-bottom: 0px;">기존파일:
										${dto.files}</p></a>
								<div class="custom-file">
									<input type="file" class="custom-file-input"
										id="inputGroupFile01" name="files" size="100"> <label
										class="custom-file-label" for="inputGroupFile01">파일업로드</label>
								</div> </c:forEach></td>
						</tr>
					</tbody>
				</table>
...
<script
	src="${path}/resources/assets/libs/ckeditor/samples/js/sample.js"></script>
<script src="${path}/resources/dist/js/custom.min.js "></script>
