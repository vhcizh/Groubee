                            ...
                            <tbody>
                             <!-- row -->
                                ...
                                <tr class="unread">
                                    ...
                                    <td class="py-2 px-3 no-wrap text-truncate"> 
                                           <a onclick="window.open('${path}/comcheckoutDetail.fo?doc_id=${dto.doc_id}','기안문서','width=850,height=1100,scrollbars=yes');" href="${path}/prechecklist.ap?stateid=on"> <span class="blue-grey-text text-darken-4">${dto.title}</span></a>
                                    </td>
                            ...
                            <ul class="pagination justify-content-center">
                            	...
                            	<c:forEach var = "dto" items="${list}" begin = "0" end = "0">
	                            	<c:if test="${paging.startPage > 10}">
	                            		<li class="page-item"><a class="page-link" href="${path}/prechecklist.ap?stateid=${dto.stateid}&pageNum=${paging.prev}">Previous</a></li>
									</c:if>
									<!-- 페이지 -->
									<c:forEach var="num" begin="${paging.startPage}" end="${paging.endPage}">
										<li class="page-item"><a class="page-link" href="${path}/prechecklist.ap?stateid=${dto.stateid}&pageNum=${num}">${num}</a></li>
									</c:forEach>
									<!-- 다음 버튼 -->
									<c:if test="${paging.endPage < paging.pageCount}">
										<li class="page-item"><a class="page-link" href="${path}/prechecklist.ap?stateid=${dto.stateid}&pageNum=${paging.next}">Next</a></li>
									</c:if>
								</c:forEach>
                            </ul>
                        </nav>
