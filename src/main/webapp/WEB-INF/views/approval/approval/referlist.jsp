                            ...
                            <tbody>
                             <!-- row -->
                                ...
                                <tr class="unread">
                                    ...
                                    <td class="py-2 px-3 no-wrap text-truncate"> 
                                           <a onclick="window.open('${path}/comcheckoutDetail.fo?doc_id=${dto.doc_id}','기안문서','width=850,height=1100,scrollbars=yes');" href="${path}/referlist.ap?stateid=com"> <span class="blue-grey-text text-darken-4">${dto.title}</span></a>
                                    </td>
